...
class Api(object):
    ...
    def parciais(self, rodada:int|None=None) -> Dict[int, Atleta]:
        ...
        if self.mercado().status.id == 1 or rodada is not None:
    ...
    def _raw_request(self, url: str, params: Optional[Dict[str, Any]] = None) -> requests.models.Response:
        attempts = self._attempts
        while attempts:
            try:
